...
public ref partial struct ValueStringBuilderHidden
{
...
#pragma warning restore IDE0032 // Use auto property
    ...
    public ValueStringBuilderHidden(Span<char> initialBuffer)
    {
    ...
    public ValueStringBuilderHidden(int initialCapacity)
    {
