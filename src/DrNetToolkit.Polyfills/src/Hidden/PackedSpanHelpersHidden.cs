...
/// </summary>
public static partial class PackedSpanHelpersHidden
{
...
#pragma warning disable CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type
    ...
    public static int IndexOf(ref char searchSpace, char value, int length) =>
        IndexOf<SpanHelpersHidden.DontNegate<short>, NopTransform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value, length);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CompExactlyDependsOn(typeof(Sse2))]
    public static int IndexOfAnyExcept(ref char searchSpace, char value, int length) =>
        IndexOf<SpanHelpersHidden.Negate<short>, NopTransform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value, length);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CompExactlyDependsOn(typeof(Sse2))]
    public static int IndexOfAny(ref char searchSpace, char value0, char value1, int length) =>
        IndexOfAny<SpanHelpersHidden.DontNegate<short>, NopTransform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, length);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CompExactlyDependsOn(typeof(Sse2))]
    public static int IndexOfAnyExcept(ref char searchSpace, char value0, char value1, int length) =>
        IndexOfAny<SpanHelpersHidden.Negate<short>, NopTransform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, length);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CompExactlyDependsOn(typeof(Sse2))]
    public static int IndexOfAny(ref char searchSpace, char value0, char value1, char value2, int length) =>
        IndexOfAny<SpanHelpersHidden.DontNegate<short>>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, (short)value2, length);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CompExactlyDependsOn(typeof(Sse2))]
    public static int IndexOfAnyExcept(ref char searchSpace, char value0, char value1, char value2, int length) =>
        IndexOfAny<SpanHelpersHidden.Negate<short>>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, (short)value2, length);
    ...
    public static int IndexOfAnyIgnoreCase(ref char searchSpace, char value, int length)
    {
        ...
        return IndexOf<SpanHelpersHidden.DontNegate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value, length);
    }
    ...
    public static int IndexOfAnyExceptIgnoreCase(ref char searchSpace, char value, int length)
    {
        ...
        return IndexOf<SpanHelpersHidden.Negate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value, length);
    }
    ...
    public static int IndexOfAnyIgnoreCase(ref char searchSpace, char value0, char value1, int length)
    {
        ...
        return IndexOfAny<SpanHelpersHidden.DontNegate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, length);
    }
    ...
    public static int IndexOfAnyExceptIgnoreCase(ref char searchSpace, char value0, char value1, int length)
    {
        ...
        return IndexOfAny<SpanHelpersHidden.Negate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, length);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CompExactlyDependsOn(typeof(Sse2))]
    public static int IndexOfAnyInRange(ref char searchSpace, char lowInclusive, char rangeInclusive, int length) =>
        IndexOfAnyInRange<SpanHelpersHidden.DontNegate<short>>(ref Unsafe.As<char, short>(ref searchSpace), (short)lowInclusive, (short)rangeInclusive, length);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CompExactlyDependsOn(typeof(Sse2))]
    public static int IndexOfAnyExceptInRange(ref char searchSpace, char lowInclusive, char rangeInclusive, int length) =>
        IndexOfAnyInRange<SpanHelpersHidden.Negate<short>>(ref Unsafe.As<char, short>(ref searchSpace), (short)lowInclusive, (short)rangeInclusive, length);
    ...
    private static int IndexOf<TNegator, TTransform>(ref short searchSpace, short value, int length)
        where TNegator : struct, SpanHelpersHidden.INegator<short>
    ...
    private static bool NegateIfNeeded<TNegator>(bool result)
        where TNegator : struct, SpanHelpersHidden.INegator<short> =>
        typeof(TNegator) == typeof(SpanHelpersHidden.DontNegate<short>) ? result : !result;
    ...
    private static bool HasMatch<TNegator>(Vector512<byte> left, Vector512<byte> right)
        where TNegator : struct, SpanHelpersHidden.INegator<short>
    {
        return (typeof(TNegator) == typeof(SpanHelpersHidden.DontNegate<short>))
    ...
    private static int ComputeFirstIndex(ref short searchSpace, ref short current, Vector128<byte> equals)
    {
        ...
        int index = BitOperationsPolyfills.TrailingZeroCount(notEqualsElements);
