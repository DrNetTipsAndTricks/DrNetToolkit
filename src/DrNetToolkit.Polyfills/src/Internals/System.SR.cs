...
internal static partial class SR
{
    ...
    ///// <summary>Unexpected HRESULT has been returned from a call to a COM component.</summary>
    ...
    ///// <summary>Known custom attribute named arg not recognized.</summary>
    //internal static string @Arg_CustomAttributeUnknownNamedArgument => GetResourceString("Arg_CustomAttributeUnknownNamedArgument");
    ///// <summary>Known custom attribute blob has repeated named argument.</summary>
    //internal static string @Arg_CustomAttributeDuplicateNamedArgument => GetResourceString("Arg_CustomAttributeDuplicateNamedArgument");
    ...
    //internal static string @Argument_WrongSizeArrayInNativeStruct => GetResourceString("Argument_WrongSizeArrayInNativeStruct");
    ...
    ///// <summary>Object type {0} does not match target type {1}.</summary>
    //internal static string @RFLCT_Targ_ITargMismatch_WithType => GetResourceString("RFLCT_Targ_ITargMismatch_WithType");
    ...
    ///// <summary>The lock has reached the limit of recursive enters.</summary>
    //internal static string @Lock_Enter_LockRecursionException => GetResourceString("Lock_Enter_LockRecursionException");
    ///// <summary>The lock has reached the limit of how many threads may wait for the lock.</summary>
    //internal static string @Lock_Enter_WaiterCountOverflow_OutOfMemoryException => GetResourceString("Lock_Enter_WaiterCountOverflow_OutOfMemoryException");
    ///// <summary>The calling thread does not hold the lock.</summary>
    //internal static string @Lock_Exit_SynchronizationLockException => GetResourceString("Lock_Exit_SynchronizationLockException");
    ...
    ///// <summary>The provided task must have already completed.</summary>
    //internal static string @Task_MustBeCompleted => GetResourceString("Task_MustBeCompleted");
    ...
    ///// <summary>One or more system calls failed: {0}</summary>
    //internal static string @Unix_SystemCallErrors => GetResourceString("Unix_SystemCallErrors");
    ...
    ///// <summary>{0} is not supported for {1}, when HybridGlobalization=true. Disable it to load larger ICU bundle, then use this option.</summary>
    //internal static string @PlatformNotSupportedWithReason_HybridGlobalization => GetResourceString("PlatformNotSupportedWithReason_HybridGlobalization");
    ...
    ///// <summary>SearchValues&lt;string&gt; supports only StringComparison.Ordinal and StringComparison.OrdinalIgnoreCase.</summary>
    //internal static string @Argument_SearchValues_UnsupportedStringComparison => GetResourceString("Argument_SearchValues_UnsupportedStringComparison");
    ///// <summary>ComVariants containing SAFEARRAYs are not supported on this platform</summary>
    //internal static string @ComVariant_SafeArray_PlatformNotSupported => GetResourceString("ComVariant_SafeArray_PlatformNotSupported");
    ///// <summary>Size of {0} should be the same size as the value specified by {1}</summary>
    //internal static string @ComVariant_SizeMustMatchVariantSize => GetResourceString("ComVariant_SizeMustMatchVariantSize");
    ///// <summary>Variant type '{0}' is not one of the supported variant types for this operation: [{1}]</summary>
    //internal static string @ComVariant_TypeIsNotSupportedType => GetResourceString("ComVariant_TypeIsNotSupportedType");
    ///// <summary>VT_DECIMAL is not supported in CreateRaw. Use the Create method.</summary>
    //internal static string @ComVariant_VT_DECIMAL_NotSupported_CreateRaw => GetResourceString("ComVariant_VT_DECIMAL_NotSupported_CreateRaw");
    ///// <summary>VT_DECIMAL is not supported in GetRawDataRef. Use the As method.</summary>
    //internal static string @ComVariant_VT_DECIMAL_NotSupported_RawDataRef => GetResourceString("ComVariant_VT_DECIMAL_NotSupported_RawDataRef");
    ///// <summary>VT_VARIANT is not supported in variants.</summary>
    //internal static string @ComVariant_VT_VARIANT_In_Variant => GetResourceString("ComVariant_VT_VARIANT_In_Variant");
    ///// <summary>Unsupported type</summary>
    //internal static string @UnsupportedType => GetResourceString("UnsupportedType");
    ///// <summary>This operation is not available because the reflection support was disabled at compile time.</summary>
    //internal static string @Reflection_Disabled => GetResourceString("Reflection_Disabled");
    ///// <summary>Cannot set initonly static field '{0}' after type '{1}' is initialized.</summary>
    //internal static string @RFLCT_CannotSetInitonlyStaticField => GetResourceString("RFLCT_CannotSetInitonlyStaticField");
    ///// <summary>This AssemblyBuilder instance doesn't support saving. Use AssemblyBuilder.DefinePersistedAssembly to create an AssemblyBuilder instance that supports saving.</summary>
    //internal static string @NotSupported_AssemblySave => GetResourceString("NotSupported_AssemblySave");
    ///// <summary>Blocking wait is not supported on the JS interop threads.</summary>
    //internal static string @WasmThreads_BlockingWaitNotSupportedOnJSInterop => GetResourceString("WasmThreads_BlockingWaitNotSupportedOnJSInterop");
